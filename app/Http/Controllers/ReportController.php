...
class ReportController extends Controller
{
    ...
    public static function grievance_report()
    {
        ...
        if (session()->get('user_type') == 0) {
            ...
            foreach ($grievance_report as $griv) {
                if ($griv->close_status == 0) {
                    $pending_griv++;
                } elseif ($griv->close_status == 1) {
                    $close_griv++;
                } elseif ($griv->close_status == 2) {
                    $resolve_griv++;
                } elseif ($griv->close_status == 3) {
                    $froward_griv++;
                }
            }
        } else {
        ...
        $report = ['total_griv'=>$total_griv, 'pending_griv'=>$pending_griv, 'close_griv'=>$close_griv, 'forward_griv'=>$froward_griv, 'resolve_griv'=>$resolve_griv];
