...
return [
    ...
    'home'=>'হোম',
    'grievance'=>'অভিযোগ',
    'grievance_status'=>'অভিযোগ স্থিতি',
    'case_search'=>'মামলার সন্ধান',
    'todays_hearing'=>"আজকের শ্রবণ",
    'login'=>"প্রবেশ করুন",
    ...
    'case'=>"মামলা",
    'case_entry'=>"মামলার এন্ট্রি",
    'case_list'=>"মামলার তালিকা",
    'grievance'=>"অভিযোগ",
    'recieved'=>"গৃহীত",
    'forwarded'=>"ফরওয়ার্ড",
    ...
    'closed'=>"বন্ধ",
    'report'=>"প্রতিবেদন",
    'pending_grievance_report'=>"মুলতুবি অভিযোগ",
    'user_log_details'=>"লগ বিবরণ",
    'logout'=>"প্রস্থান",
    ...
    'enter_next_hearing_date'=>"পরবর্তী শুনানির তারিখ লিখুন",
    'enter_case_number'=>"মামলার নম্বর লিখুন",
    
    'enter_email'=>"ই-মেইল লিখুন",
    'enter_complain'=>"অভিযোগ লিখুন",
    'enter_attachment'=>"সংযুক্তি লিখুন",
    'enter_grievance_id'=>"অভিযোগ আইডি লিখুন",
    ...
    'save'=>"সংরক্ষণ",
    'submit'=>"উপস্থাপিত করা ",
    'search'=>"অনুসন্ধান করুন ",
    
    //admin panel
    'welcome_to_admin_panel'=>"অ্যাডমিন প্যানেলে আপনাকে স্বাগতম ",
    'malda_district_admin_portal'=>"মালদা জেলা প্রশাসন পোর্টাল",
    
    'total_grievances'=>"মোট অভিযোগ",
    'pending_grievances'=>"মুলতুবি অভিযোগ",
    'forwarded_grievances'=>"ফরোয়ার্ড অভিযোগ",
    'closed_grievances'=>"বন্ধ অভিযোগ",
    'resolved_grievances'=>"অভিযোগগুলি সমাধান করুন",
    
    //Table Heading
    'recieved_table_heading'=>"অভিযোগের তালিকা প্রাপ্ত ",
