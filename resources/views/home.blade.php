...
<head>
    ...
    <link rel='stylesheet' id='flexslider-css' href='./front/css/base.css' media='all' />
    <link rel='stylesheet' id='flexslider-css' href='./front/css/extra.css' media='all' />
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12 p-0">
                    <div class="home-slider full-cntrl-left-caption-bottom nav-white flexslider main-banner-three">
                        <ul class="slides">
                            <li>
                                <img src='./front/images/slider/1.jpg' alt='banner1' />
                                <div class="container p-0">
                                    <div class="slide-caption pl-0">
                                        <p class="heading3">Malda District</p>
                                        <p>Description</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <img src='./front/images/slider/2.jpg' alt='banner1' />
                                <div class="container p-0">
                                    <div class="slide-caption pl-0">
                                        <p class="heading3">Malda District</p>
                                        <p>Description</p>
                            ...
                            <li>
                                <img src='./front/images/slider/3.jpg' alt='banner1' />
                                <div class="container p-0">
                                    <div class="slide-caption  pl-0">
                                        <p class="heading3">Malda District</p>
                                        <p>Description</p>
                            ...
                            <li>
                                <img src='./front/images/slider/4.jpg' alt='banner1' />
                                <div class="container p-0">
                                    <div class="slide-caption  pl-0">
                                        <p class="heading3">Malda District</p>
                                        <p>Description</p>
            ...
            <div class="row p-5 text-center">
                ...
                <div class="col-sm-3">
                    <span class="icon-phone highlight"></span>
                    <div class="list-text">Important telephone numbers</div>
                </div>
                <div class="col-sm-3">
                    <span class="icon-support highlight"></span>
                    <div class="list-text">Emergency services</div>
                </div>
                <div class="col-sm-3">
                    <span class="icon-tourism highlight"></span>
                    <div class="list-text">Tourism</div>
                </div>
            </div>
            <div class="row p-5">
                <div class="col-sm-6 mb-5  mb-md-0 about_district_home bg-light">
                    <h3 class="uppercase">About District</h3>
                    <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla et erat nulla. Nam vitae magna tincidunt, ornare augue quis, pellentesque metus. Duis quis purus a urna laoreet lacinia eget nec sapien. Nulla vehicula, magna sit amet luctus
                        bibendum, nisl diam auctor sem, condimentum molestie tortor ipsum eu enim. Duis pulvinar rhoncus augue a semper. Aenean hendrerit purus a turpis feugiat, eu varius libero pharetra. In enim ipsum, dignissim in fringilla hendrerit, porttitor
                        non dui. Nam interdum nulla gravida, hendrerit neque vel, aliquet nibh. &nbsp;&nbsp;<a href="#">Read More</a></p>
                </div>
                <div class="col-sm-6">
                    <div class="tab bg-light">
                        <button class="tablinks active" onclick="openTab(event, 'London')">What's New?</button>
                        ...
                        <div class="col-sm-2 text-center p-3">
                            <a href="#">
                                <div class="bg-primary p-5">
                                    <i class="fa fa-3x icon-certificate"></i>
                                    <div class="home-service-text">Certificate</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-sm-2 text-center p-3">
                            <a href="#">
                                <div class="bg-success p-5">
                                    <i class="fa fa-3x icon-taxes-2"></i>
                                    <div class="home-service-text">Bill</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-sm-2 text-center p-3">
                            <a href="#">
                                <div class="bg-danger p-5">
                                    <i class="fa fa-3x icon-supply"></i>
                                    <div class="home-service-text">Supply</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-sm-2 text-center p-3">
                            <a href="#">
                                <div class="bg-warning p-5">
                                    <i class="fa fa-3x icon-magisterial"></i>
                                    <div class="home-service-text">Magisterial</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-sm-2 text-center p-3">
                            <a href="#">
                                <div class="bg-secondary p-5">
                                    <i class="fa fa-3x icon-revenue"></i>
                                    <div class="home-service-text">Revenue</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-sm-2 text-center p-3">
                            <a href="#">
                                <div class="bg-dark p-5">
                                    <i class="fa fa-3x icon-social-security"></i>
                                    <div class="home-service-text">Security</div>
                                </div>
                            </a>
                        </div>
                    </div>
            ...
            <div class="row p-5">
                ...
                <div class="col-sm-3 quick-links">
                    ...
                    <ul>
                        <li>E Office</li>
                        <li>Aadhar Enable PDS</li>
                        <li>Right to Inform Act</li>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="row">
                        <div class="col-sm-4 helpline-number">
                            <div class="head">Citizen's Call center -</div>
                            <div class="number">155300</div>
                        </div>
                        <div class="col-sm-4 helpline-number">
                            <div class="head">Women Helpline -</div>
                            <div class="number">1098</div>
                        </div>
                        <div class="col-sm-4 helpline-number">
                            <div class="head">Child Helpline -</div>
                            <div class="number">1091</div>
                        </div>
                        <div class="col-sm-4 helpline-number">
                            <div class="head">Crime Stopper -</div>
